...
module.exports = {
    ...
    BOT_NAME: process.env.BOT_NAME || "🌟𝐊𝚰𝐘𝚯𝚻𝚫𝐊𝚫 𝚫𝐘𝚫𝚴𝚯𝐊𝚯𝐉𝚰 MD❤️",  // Bot's display name
    ...
    OWNER_NUMBER: process.env.OWNER_NUMBER || "24104686989",  // Owner's WhatsApp number
    OWNER_NAME: process.env.OWNER_NAME || "🌟𝐊𝚰𝐘𝚯𝚻𝚫𝐊𝚫 𝚫𝐘𝚫𝚴𝚯𝐊𝚯𝐉𝚰❤️",           // Owner's name
    DEV: process.env.DEV || "24104686989",                     // Developer's contact number
    DEVELOPER_NUMBER: '24104686989@s.whatsapp.net',            // Developer's WhatsApp ID
    ...
    STICKER_NAME: process.env.STICKER_NAME || "🌟𝐊𝚰𝐘𝚯𝚻𝚫𝐊𝚫 𝚫𝐘𝚫𝚴𝚯𝐊𝚯𝐉𝚰❤️",     // Sticker pack name
    ...
    ALIVE_IMG: process.env.ALIVE_IMG || "https://files.catbox.moe/mkxtrh.jpg",  // Bot's "alive" image
